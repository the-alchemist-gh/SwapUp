    ...
    <>
        <div className="w-full px-8 border-b border-gray-200 py-4 justify-center">
          <div className="flex flex-nowrap overflow-x-auto md:justify-center">
            <button type="button" className="inline-flex justify-center items-center px-4 py-2 mx-2 border border-transparent rounded-full shadow-sm text-sm font-medium bg-gray-200 hover:bg-slate-500 hover:text-white">
